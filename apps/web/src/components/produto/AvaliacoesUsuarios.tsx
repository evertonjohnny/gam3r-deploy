...
interface AvaliacoesUsuariosProps {
	produto: Produto;
}

export default function AvaliacoesUsuarios({
	produto,
}: AvaliacoesUsuariosProps) {
	return (
		<div className="flex flex-col gap-2">
			...
			<p className="font-light text-zinc-300">
				...
				vídeo dedicada. Outros destacam a qualidade do som o conforme do fone de
				ouvido.
			</p>
			<div className="flex items-center gap-5 mt-5">
				<div className="flex flex-col gap-2 items-center">
					<div className="text-7xl text-pink-600">{produto.nota}</div>
					<NotaReview nota={produto.nota} tamanho={18} />
					<div className="font-light text-sm text-zinc-300">
						(198 Comentários)
					</div>
				</div>
				<div className="flex-1 flex items-center bg-violet-dark/50 min-h-32 rounded-xl">
					<ul className="flex flex-col list-disc px-10 gap-1 p-4">
